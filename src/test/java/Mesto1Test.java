...
public class Mesto1Test {
    ...
    String bearerToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MWZlMTcwZjgyMGZmYzAwM2QxM2MzZWYiLCJpYXQiOjE2NTE0MDMzODMsImV4cCI6MTY1MjAwODE4M30.3Kr-McBp3EFJwyvro__8BJrfTQ3-Y3LVlZeZy_S91KY";
    ...
    public void addNewPhoto() {
        given()
                ...
                .body("{\"na\":\"Москва\",\"link\":\"https://code.s3.yandex.net/qa-automation-engineer/java/files/paid-track/sprint1/photoSelenium.jpg\"}") // Формируем тело запроса
